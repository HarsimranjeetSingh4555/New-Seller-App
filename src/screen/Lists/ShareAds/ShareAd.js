...
import { StyleSheet, Text, View, Image, Dimensions, SafeAreaView, ScrollView, Label, StatusBar, FlatList, TouchableOpacity, TextInput } from 'react-native';
...
const gustData = [

  {
    ...
    Name: 'Harsimranjeet Singh Tarwal Prabjot',
    Email: 'simranjeet.extech8699283148@gmail.com',
    DistName: 'Dist. Name',
    DateTime: 'ShareAds Date & Time:-'
  },
            ...
            <View style={styles.Name1}>
              <View style={styles.topmain}>
                ...
                <View style={styles.maintext}>
                  <Text style={styles.toptext}>Share Ads </Text>
                </View>
