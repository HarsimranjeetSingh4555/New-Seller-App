...
import { StyleSheet, Text, View, Image, SafeAreaView, ScrollView,Dimensions, Label, StatusBar, FlatList, TouchableOpacity, TextInput } from 'react-native';
            ...
            <View style={styles.Name1}>
              <View style={styles.topmain}>
                ...
                <View style={styles.maintext}>
                  <Text style={styles.toptext}>Like Ads </Text>
                </View>
