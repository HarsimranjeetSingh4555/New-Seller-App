        ...
        <ScrollView>
            <View>
                <View style={styles.main}>
                    ...
                    <View>
                        <Text style={styles.wel}>All Plan Details</Text>
                    </View>
                </View>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Business')} style={styles.border}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Ultimate')} style={styles.border}>
