                    ...
                    <View>
                        <View style={styles.Input}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <View style={{ flexDirection: 'row' }}>
                                    ...
                                    <View>
                                        <Text style={styles.mainHeader}>{item.header}</Text>
                                    </View>
                                </View>
                        ...
                        <View style={styles.Input}>
                            <View style={{ justifyContent: 'space-around' }}>
                                <Text style={styles.package}>{item.header2}</Text>
                                <Text style={styles.price}>{item.header3}</Text>
                            </View>
                        </View>

                        <View style={styles.Border}>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot}>{item.dot}</Text>
                        ...
                        <View style={styles.Border}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text5}</Text>
                            </View>

                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text6}</Text>
                            </View>

                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text7}</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text8}</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text9}</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text10}</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.Border2}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot}>{item.dot}</Text>
                                <Text style={styles.Text3}>{item.text12}</Text>
                            </View>

                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot}>{item.dot}</Text>
                                <Text style={styles.Text3}>{item.text13}</Text>
                            </View>
                        ...
                        <View style={styles.Border}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text14}</Text>
                            </View>

                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text15} </Text>
                            </View>

                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text16}</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text17}</Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text18} </Text>
                            </View>
                            <View style={{ flexDirection: 'row' }}>
                                <Text style={styles.dot2}>{item.dot}</Text>
                                <Text style={styles.Text2}>{item.text19}</Text>
                            </View>
                        </View>
