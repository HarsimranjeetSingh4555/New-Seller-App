            ...
            <ScrollView>
                ...
                <View >
                    ...
                    <View style={{flexDirection:'row',justifyContent:'center',marginVertical:80}}>
                        <View>
                            <Image source={require('../../../HomeScreen/assets/ai.png')} style={styles.icon}/>
                        </View>
                        <View>
                            <Text style={{color:"#000",fontSize:20,fontWeight:'900',marginTop:25,marginHorizontal:10}}>A.I.Customers</Text>
                        </View>
                    </View>
