...
import { StyleSheet, Text, Dimensions, View, Image, SafeAreaView, ScrollView, Label, StatusBar, FlatList, TouchableOpacity, TextInput } from 'react-native';
...
const NewZealandList = ({ navigation }) => {
  ...
  const GustData = ({ item, navigation }) => {
    ...
    return (
      <View style={styles.mainList}>
        ...
        <View>
          <View style={{ backgroundColor: '#0006C1', padding: 19, borderRadius: 10, marginVertical: 5 }}>
            ...
            <View style={styles.Name1}>
              <View style={styles.topmain}>
                <View style={styles.topad}>
                  <Image source={require('../../HomeScreen/assets/nz.png')} style={styles.ad} />
                </View>

                <View style={styles.maintext}>
                  <Text style={styles.toptext}>NewZealand</Text>
                </View>
